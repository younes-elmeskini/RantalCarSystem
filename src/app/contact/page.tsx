  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <SectionAnimation direction="up" className="text-center mb-16">
          <motion.h1 
          ...
          >
            Nous sommes là pour vous aider. N&apos;hésitez pas à nous contacter pour toute question concernant nos services de location de voitures.
          </motion.p>
        </SectionAnimation>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Formulaire de contact */}
          <SectionAnimation direction="left" className="bg-white rounded-2xl shadow-xl p-8">
            <motion.h2 
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                className="w-full bg-blue-600 text-white py-4 px-6 rounded-lg font-semibold hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2"
          ...
          <SectionAnimation direction="right" className="space-y-8">
            <motion.div 
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Service 24h/24 pour les urgences</p>
                  </div>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              ...
              <SimpleMap className="w-full h-64" />
            </motion.div>
          </SectionAnimation>
        </div>
      </div>
